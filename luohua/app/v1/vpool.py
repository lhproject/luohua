...
def vpool_creat_v1_view(request):
    ...
    :Allow: POST
    :URL 格式: :wyurl:`api:vpool-creat-v1`
    :GET 参数: 无
    :POST 参数:
        ======== ======== =================================================
         字段     类型     说明
    ...
    if vtpid is not None and VPool.fetch(vtpid) is not None:
        # 所请求的 vtpid 已经被占据了
...
def vpool_stat_v1_view(request, vtpid):
    ...
    :Allow: GET
    :URL 格式: :wyurl:`api:vpool-stat-v1`
    :GET 参数:
        ======= ========= =================================================
         字段    类型      说明
        ======= ========= =================================================
...
def vpool_getdents_v1_view(request, vtpid):
    ...
    :Allow: GET
    :URL 格式: :wyurl:`api:vpool-getdents-v1`
    :GET 参数:
        ======= ========= =================================================
         字段    类型      说明
        ======= ========= =================================================
