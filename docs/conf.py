# -*- coding: utf-8 -*-
#
# luohua documentation build configuration file, created by
...
extensions = [
        ...
        # pull in weiyu's Sphinx integration for automatically generating URL
        # signatures and the like
        'weiyu.utils.sphinxsupport',
        ]

# default settings for weiyu
# weiyu_router_type = 'http'
...
project = u'luohua'
copyright = u'2013-2014, JNRain'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
try:
    # NOTE: this is the same approach used by the virtualenv project
...
latex_documents = [
  ('index', 'luohua.tex', u'luohua Documentation',
   u'JNRain', 'manual'),
]
...
man_pages = [
    ('index', 'luohua', u'luohua Documentation',
     [u'JNRain'], 1)
]
...
texinfo_documents = [
  ('index', 'luohua', u'luohua Documentation',
   u'JNRain', 'luohua', 'One line description of project.',
   'Miscellaneous'),
]
